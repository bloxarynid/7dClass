...
window.rankingData = [
    ...
    { rank: 7, name: "Farzan Ahza Argani & Azzam Amanullah", notes: "(Ranking 7)" },
    { rank: 9, name: "Rajendra Veron Alerea & Azelia Nur Azzahra", notes: "(Ranking 9)" },
    { rank: 10, name: "Mutia Almas Fatimatuzzahra" },
    { rank: 11, name: "Reina Al Yasmin" },
    { rank: 13, name: "Nafis Prawiro & Alifah Adeliza", notes: "(Ranking 13)" },
    { rank: 14, name: "Mohammad Asadell Akhtar" },
    { rank: 15, name: "Kirana Kamalia Ayu Wardaniningrum" },
    { rank: 16, name: "Firli Alisa Rahma" },
    { rank: 17, name: "Keisha Novelis Nafeeza Zaafarani" },
    { rank: 18, name: "Amalia Rezki Azizi" },
    { rank: 20, name: "Muhammad Ardiansyah, Aryasatya Byakta, & Priska Oktaviana", notes: "(Ranking 20)" },
    { rank: 21, name: "Nara Ayu Apriliani" },
    { rank: 22, name: "Selena Zayna Tatum" },
    { rank: 23, name: "Harist Abdul Hakim" },
    { rank: 24, name: "Joshua Veddyttarro" },
    { rank: 25, name: "Riyan Ade Saputra" },
    { rank: 26, name: "Abiyyu Nocherino Revantara" },
    { rank: 27, name: "Ahmed Fadee Aisyhafiy" },
    { rank: 28, name: "Ghatfaan Fayaadh Aufaa" }
];
